   ...
   /* pointsArray.sort(function (x, y) {
    ...
    if(totalPoints>=1){
      ...
      <div class="text-center">
        <a href="./images/trabajos-y-proyectos-investigativos/premios-trabajos-y-proyectos-investigativos.zip" target="_blank" class="btn-final-points" >Descargar premios</a>
      </div>
      `;
    }
    else{
