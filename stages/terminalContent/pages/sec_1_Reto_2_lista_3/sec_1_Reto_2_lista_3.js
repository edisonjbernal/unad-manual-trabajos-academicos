class terminalContentClass_sec_1_Reto_2_lista_3 extends generalPage{
    ...
    /* */
      ...
      <div class="text-general ">
          ...
          <div class="drag-and-drop-element">
              <p>La elección del tipo, tamaño y color de letra en un trabajo escrito sirven de apoyo para la expresión de las ideas escritas. El escrito de todos los párrafos de un solo trabajo debe mantener <strong class="strong-text-change" id="text-1-terminalContent_Sec_1_Reto_2_lista_3">-- 1 --</strong> tipo de letra durante todo su contenido. El color de la letra debe ser <strong class="strong-text-change" id="text-2-terminalContent_Sec_1_Reto_2_lista_3"> -- 2 -- </strong>, y en caso de impresión, ésta deberá hacerse <strong class="strong-text-change" id="text-3-terminalContent_Sec_1_Reto_2_lista_3"> -- 3 -- </strong> de la hoja, a menos que por orientaciones docentes se requiera algo diferente.</p>
              <div class="text-change-validator">
                <h3>-- 1 --</h3>
                  <button 
                    class="btn-general" 
                    data-id-to-select="text-1-terminalContent_Sec_1_Reto_2_lista_3"
                    ...
                    onclick="text_TerminalContent_Sec_1_Reto_2_lista_3.change(this);">
                    un solo
                  </button> 
                  <button class="btn-general" data-id-to-select="text-1-terminalContent_Sec_1_Reto_2_lista_3"
                  ...
                  onclick="text_TerminalContent_Sec_1_Reto_2_lista_3.change(this);">más de un solo</button>
              ...
              <div class="text-change-validator">
                <h3>-- 2 --</h3>
                  <button 
                    class="btn-general" 
                    data-id-to-select="text-2-terminalContent_Sec_1_Reto_2_lista_3"
                  ...
                  <button class="btn-general" data-id-to-select="text-2-terminalContent_Sec_1_Reto_2_lista_3"
                  ...
                  data-correct-answer="true"
                  onclick="text_TerminalContent_Sec_1_Reto_2_lista_3.change(this);">negro</button>
                  <div class="feedback"></div>
              </div>
              <div class="text-change-validator">
                <h3>-- 3 --</h3>
                  <button 
                    class="btn-general" 
                    data-id-to-select="text-3-terminalContent_Sec_1_Reto_2_lista_3"
                  ...
                  <button class="btn-general" data-id-to-select="text-3-terminalContent_Sec_1_Reto_2_lista_3"
                  ...
                  onclick="text_TerminalContent_Sec_1_Reto_2_lista_3.change(this);">por ambas caras</button>
                  <div class="feedback"></div>
              </div>
          </div>
      </div>
...
stagePage.pageContainerSet('sec_1_Reto_2_lista_3',terminalContentClass_sec_1_Reto_2_lista_3);
 
let text_TerminalContent_Sec_1_Reto_2_lista_3 = new textChangeCustomClass();
